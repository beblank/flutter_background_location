...
import com.shahxad.flutter_background_location.R
...
class FlutterBackgroundLocationPlugin() : MethodCallHandler, PluginRegistry.RequestPermissionsResultListener {
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "flutter_background_location")
            channel.setMethodCallHandler(FlutterBackgroundLocationPlugin(registrar.activity(), channel))
        }

        private const val TAG = "com.shahxad.Log.Tag"
